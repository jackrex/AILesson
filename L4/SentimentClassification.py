...
def optimize_logistic_regression():
    ...
    classifier = LogisticRegression(penalty='l2', dual=False, tol=0.0001, C=1.0,fit_intercept=True, intercept_scaling=1, class_weight='balanced', random_state=None, solver='sag', max_iter=2000, multi_class='ovr', verbose=0, warm_start=False, n_jobs=-1)
    count_vec = CountVectorizer()
    x_train = count_vec.fit_transform(train_movie_data.data)
    ...
    #                          tuned_parameters, cv=10, scoring='accuracy', n_iter=1000)
